...
public class EnderecoDaoImpl implements EnderecoDAO {
	...
	public List<Endereco> getAll() {
		return (List<Endereco>) hibernateTemplate.find("from "
				+ Endereco.class.getName());
	}

	@SuppressWarnings("unchecked")
	public List<Endereco> selectByRua(String rua) {
		return (List<Endereco>) hibernateTemplate.find(
				"from Endereco e WHERE e.rua= ?", rua);
	}

	@SuppressWarnings("unchecked")
	public List<Endereco> selectByCep(String cep) {
		return (List<Endereco>) hibernateTemplate.find(
				"from Endereco e WHERE e.cep= ?", cep);
	}
